...
#  generate simulation data 1
 
x_train= np.random.uniform(low=-3,high=3,size=(5000,2))
y1_train=1+7*x_train[:,0]+2*x_train[:,1]+4*x_train[:,0]*x_train[:,1]+np.random.normal(0,1,size=(5000,1)).T
x_test= np.random.uniform(low=-3,high=3,size=(1000,2))
y1_test=1+7*x_test[:,0]+2*x_test[:,1]+4*x_test[:,0]*x_test[:,1]+np.random.normal(0,1,size=(1000,1)).T
